    ...
    return (
        <div className="min-h-screen relative overflow-hidden text-white">
            ...
            <div className="fixed inset-0 z-0">
                {/* Deep base */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#010d05] via-[#020e06] to-[#030508]" />

                {/* Main green orb - top right */}
                <div className="absolute -top-48 -right-48 w-[650px] h-[650px] bg-emerald-500/20 rounded-full blur-[130px] animate-pulse" style={{ animationDuration: '5s' }} />

                {/* Lime accent - bottom left */}
                <div className="absolute -bottom-48 -left-32 w-[600px] h-[600px] bg-green-600/25 rounded-full blur-[120px] animate-pulse" style={{ animationDuration: '7s', animationDelay: '1.5s' }} />

                {/* Center glow */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-teal-800/15 rounded-full blur-[90px] animate-pulse" style={{ animationDuration: '4s', animationDelay: '0.5s' }} />
