    ...
    return (
        <div className="p-3 md:p-6 space-y-4 relative min-h-screen">
            ...
            <div className="relative z-10 flex items-center flex-row space-x-3 mb-5">
                <div className="bg-gradient-to-br from-teal-500/20 to-blue-500/20 p-2.5 rounded-xl border border-teal-500/30 shadow-[0_0_30px_rgba(20,184,166,0.2)] shrink-0">
                    <Stethoscope className="text-teal-400 w-5 h-5" />
                </div>
                <div>
