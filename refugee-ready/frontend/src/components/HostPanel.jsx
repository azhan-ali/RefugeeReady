    ...
    return (
        <div className="min-h-screen relative overflow-hidden text-white">
            ...
            <div className="fixed inset-0 z-0">
                {/* Deep base gradient */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#0a0500] via-[#0f0800] to-[#050208]" />

                {/* Animated warm orange orb - top left */}
                <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-orange-600/25 rounded-full blur-[120px] animate-pulse" style={{ animationDuration: '4s' }} />

                {/* Deep amber orb - bottom right */}
                <div className="absolute -bottom-60 -right-40 w-[700px] h-[700px] bg-amber-500/20 rounded-full blur-[140px] animate-pulse" style={{ animationDuration: '6s', animationDelay: '1s' }} />

                {/* Small ember - center top */}
                <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[300px] h-[300px] bg-orange-800/20 rounded-full blur-[80px] animate-pulse" style={{ animationDuration: '5s', animationDelay: '2s' }} />
